...
#touch $tmpFile
  ...
  do
   ...
   # echo "start $startTime for file $f"
#while read -r line
#do
...
#        echo "restarting $count" 
    ...
    `../../hello-samza/deploy/kafka/bin/kafka-console-producer.sh --topic shadi-mem-test-in --broker-list lca1-kafka-kafka-queuing-vip.corp.linkedin.com:10251 < $f` 
#        count=0
